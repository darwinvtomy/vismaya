...
class CompanyDetailsIntroAnimation {
  CompanyDetailsIntroAnimation(this.controller)
      : bgdropOpacity = Tween(begin: 0.5, end: 1.0).animate(CurvedAnimation(
        ...
        bgdropBlur = Tween(begin: 0.0, end: 5.0).animate(CurvedAnimation(
            parent: controller,
            curve: Interval(0.0, 0.800, curve: Curves.ease))),
        avatharSize = Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: controller,
        ...
        locstionOpacity = Tween(begin: 0.0, end: 0.84).animate(CurvedAnimation(
            parent: controller,
        ...
        aboutOpacity = Tween(begin: 0.0, end: 0.85).animate(CurvedAnimation(
            parent: controller,
            curve: Interval(0.750, 0.900, curve: Curves.elasticIn))),
  ...
  final Animation<double> avatharSize;
  final Animation<double> nameOpacity;
  final Animation<double> locstionOpacity;
